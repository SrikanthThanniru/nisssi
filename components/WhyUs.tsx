    ...
    <section id="why-us" className="py-16 md:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 reveal-up">
          <span className="text-[#1a35cc] font-semibold text-sm tracking-widest uppercase text-reveal-up">Our Differentiators</span>
          <h2 className="text-4xl md:text-5xl font-black text-[#0a0f2e] mt-2 mb-4 text-mask-reveal delay-100">Why Nissi Corporate Stands Out</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-7 mb-20">
          {strengths.map(({ icon: Icon, title, desc, color, bg }, idx) => (
            <div 
              key={title} 
              className={`service-card bg-white rounded-2xl p-7 group reveal-up delay-${(idx % 3 + 1) * 100}`}
            >
        ...
        {/* Banner with image */}
        <div className="relative rounded-3xl overflow-hidden mb-12 md:mb-20 h-auto min-h-[350px] md:h-64 flex items-center reveal-up">
          <Image
          ...
          <div className="absolute inset-0 flex items-center px-6 py-8 md:px-10 md:py-0">
            <div>
              <div className="text-blue-300 font-bold text-xs tracking-widest uppercase mb-2 text-reveal-up">Our Commitment</div>
              <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-black text-white mb-3 max-w-xl leading-tight text-mask-reveal delay-100">
                &ldquo;Trusted regional partner for timely, end-to-end infrastructure solutions.&rdquo;
              </h3>
              <div className="text-reveal-up delay-200 mt-4">
                <div className="flex flex-row flex-wrap gap-6 sm:gap-10">
        ...
        <div className="reveal-up">
          <div className="text-center mb-10">
            <span className="text-[#1a35cc] font-semibold text-sm tracking-widest uppercase text-reveal-up">Competitive Landscape</span>
            <h3 className="text-3xl font-black text-[#0a0f2e] mt-2 text-mask-reveal delay-100">Industry Comparison</h3>
          </div>
          <div className="overflow-x-auto rounded-2xl border border-gray-200 shadow-sm reveal-up delay-200">
